...
namespace GradeBook.GradeBooks
{
    public abstract class BaseGradeBook
    {
        ...
        double GetGPAWeighted(StudentType studentType, double input)
        {
        ...
        public virtual double GetGPA(char letterGrade, StudentType studentType)
        {
            ...
            {
                case 'A':
                    return GetGPAWeighted(studentType, 4);
                case 'B':
                    return GetGPAWeighted(studentType, 3);
                case 'C':
                    return GetGPAWeighted(studentType, 2);
                case 'D':
                    return GetGPAWeighted(studentType, 1);
                case 'F':
                    return GetGPAWeighted(studentType, 0);
            }
            return 0;
        }
